...
public class User {
    ...
    public User(Integer userId, String loginId, String password, String lastName, String firstName,
                String gender, String email, String imagePath, Integer keyword1, Integer keyword2,
                Integer keyword3, Integer roleId, String createdAt, String updateAt) {
        this.userId = userId;
